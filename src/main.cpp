...
DYNASP_HELPER_EXPORT htd::LibraryInstance
*
inst = NULL;
...
//        ["Frac_Ternary_Rules", 0.0000],
        ...
        //TODO: ??
        output->data("Static", "Constraints/Vars",
                     (float) instance.get()->getNumConstraints() / (float) instance.get()->getNumRules());

        output->data("Static", "Frac_Integrity_Rules",
                     (float) instance.get()->getNumConstraints() / (float) instance.get()->getNumRules());
        output->data("Static", "Frac_Binary_Constraints",
                     (float) instance.get()->getNumBinaryConstraints() / (float) instance.get()->getNumRules());
        output->data("Static", "Frac_Ternary_Constraints",
                     (float) instance.get()->getNumTernaryConstraints() / (float) instance.get()->getNumRules());
        output->data("Static", "Frac_Other_Constraints",
                     (float) instance.get()->getNumOtherConstraints() / (float) instance.get()->getNumRules());
        output->data("Static", "Frac_Cardinality_Rules",
                     (float) instance.get()->getNumCardinalityRules() / (float) instance.get()->getNumRules());
        output->data("Static", "Frac_Choice_Rules",
                     (float) instance.get()->getNumChoiceRules() / (float) instance.get()->getNumRules());
        output->data("Static", "Frac_Disjunctive_Rules",
                     (float) instance.get()->getNumDisjunctiveRules() / (float) instance.get()->getNumRules());
        output->data("Static", "Frac_Normal_Rules",
                     (float) instance.get()->getNumNormalRules() / (float) instance.get()->getNumRules());
        output->data("Static", "Frac_Weight_Rules",
                     (float) instance.get()->getNumWeightedRules() / (float) instance.get()->getNumRules());
